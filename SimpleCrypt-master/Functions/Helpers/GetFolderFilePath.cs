            ...
            await Task.Run(() =>
            {
                switch (method.ToUpperInvariant())
                {
                    ...
                    case "BLOWFISH":
                        ...
                        break;
                    default:
                        throw new ArgumentException("Invalid encryption method. Supported methods are AES, DES, 3DES, CHACHA20, and BLOWFISH.");
                }
            });
        }
            ...
            await Task.Run(() =>
            {
                switch (method.ToUpperInvariant())
                {
                    ...
                    case "BLOWFISH":
                        ...
                        break;
                    default:
                        throw new ArgumentException("Invalid decryption method. Supported methods are AES, DES, 3DES, CHACHA20, and BLOWFISH.");
                }
            });
        }
